...
function Player:init(map)
    ...
    self.animations = {
        ['idle'] = Animation(
            love.graphics.newImage('graphics/idleCape.png'),
            generateQuads('graphics/idleCape.png', 170, 132),
            0.2
        ),
        ['walking'] = Animation(
            love.graphics.newImage('graphics/walkingCape.png'),
            generateQuads('graphics/walkingCape.png', 170, 146),
            0.2
        )
    }
